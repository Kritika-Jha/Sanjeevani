...
export default function Landing() {
  return (
    <div className="stack">
      <div className="card" style={{ boxShadow: 'var(--shadow)', position: 'relative', overflow: 'hidden' }}>
        <div
          style={{
            position: 'absolute',
            inset: -120,
            background: 'radial-gradient(circle at 30% 20%, rgba(14,165,233,.18), transparent 55%), radial-gradient(circle at 70% 40%, rgba(16,185,129,.14), transparent 55%)'
          }}
        />
        <div style={{ position: 'relative' }}>
          <h1 className="pageTitle" style={{ fontSize: '1.75rem' }}>
